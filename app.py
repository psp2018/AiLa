...
with tab4:
    ...
    st.markdown(
        """
    Category 1: The Basics & Applicability (For users asking "Does this even apply to me?")
    ...
    Category 2: Website, Cookies & Marketing (For marketers and front-end developers)
    ...
    Category 3: User Rights & Data Handling (For product managers and support teams)
    ...
    Category 4: Tech Stack, Vendors & International Transfers (For CTOs and technical leads)
    ...
    Category 5: Risk, Breaches & Enforcement (For founders and management)
