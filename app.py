...
with tab3:
    ...
    st.markdown(
        """
    Category 1: The Basics & Applicability (For users asking "Does this even apply to me?")/n/n
        - I'm a US-based company with a website that gets some traffic from Europe. Does GDPR apply to me?/n
        - What is the main difference between the EU's GDPR and Switzerland's new FADP?/n
        - My company is in Germany, but we have many Swiss customers. Which law is more important for me to follow?/n
        - What exactly counts as "personal data"? Does an IP address or a user ID qualify?/n
        - What does the principle of "privacy by design" mean for my startup's new product?/n
    Category 2: Website, Cookies & Marketing (For marketers and front-end developers)/n/n
        - Do I really need a cookie banner? What are the specific rules for it to be compliant?/n
        - Can I still use Google Analytics? If so, how must I configure it to be compliant with GDPR?/n
        - Can my sales team send cold marketing emails to a list of business contacts?/n
        - What information is absolutely required in my website's privacy policy?/n
        - A user signed up for my newsletter. Can I use their email for other marketing purposes?/n
    Category 3: User Rights & Data Handling (For product managers and support teams)/n/n
        - A user has requested a copy of all their data. What do I have to provide and how quickly?/n
        - What is the "right to be forgotten" and are there any situations where I can refuse to delete a user's data?/n
        - How do I handle a data access request from a user in Switzerland under the FADP?/n
        - What is a "Data Processing Record" or "ROPA" and does my small business need to maintain one?/n
        - What is "data minimization" and can you give me a practical example for an e-commerce store?/n
    Category 4: Tech Stack, Vendors & International Transfers (For CTOs and technical leads)/n/n
        - My entire platform is built on AWS. Does their compliance mean my company is compliant?/n
        - What is a Data Processing Addendum (DPA) and do I need one with my SaaS vendors like Stripe or Mailchimp?/n
        - I use a software tool from a company based in the USA. What do I need to ensure that data transfer is legal?/n
        - What are the technical security measures (like encryption and pseudonymization) that are recommended under GDPR?/n
        - Does the new Swiss FADP have the same strict rules on transferring data outside of Switzerland as GDPR?/n
    Category 5: Risk, Breaches & Enforcement (For founders and management)/n/n
        - What are the very first steps I must take if I discover my company has had a data breach?/n
        - When is a company legally required to appoint a Data Protection Officer (DPO)?/n
        - Are the fines under the new FADP as high as the fines under GDPR?/n
        - Do I need to appoint a representative in Switzerland if my business is based in the EU?/n
        - What is the most common mistake a small business makes that leads to a privacy fine?/n
    """
    )
